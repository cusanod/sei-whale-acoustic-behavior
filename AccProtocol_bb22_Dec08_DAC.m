...
%   %% 3.1 Open sensor data from .nc
    ...
    %or get it from raw
       ...
       % for D3s
        ...
        prefix=depid;
        df=1;
        recdir='E:\SeiWhales\Tag data\dtag\bb22\bb22_115a';
        X=d3readswv(recdir, prefix, df);
        settagpath('cal', 'E:\SeiWhales\Tag data\dtag\cal');
        [CAL, D]=d3deployment(recdir, prefix, 'bb22_115a'); %looking for calibration file from each device.
        [A, CAL, fs]=d3calacc(X, CAL, 'full', 1);
        %info = make_info(depid,'D3',depid(1:2),'dc');
    ...
    %% 3.2 Import selection table 
        tabdir='E:\Tag data\FocalAccAnalysis\bb22_115a\Sound\bb22_115a_noise_removed.txt' %table file with complete address.     
        ...
        accdir='D:\Tag data\FocalAccAnalysis\bb22_115a\Acc\' %define directory to save files with acc data. Each file will have 3 variables, one for each acc axis. 
 %% 3.3 Crop samples to start_time and end_time.   
   ...
   %% 4 - Run batch processor
    ...
    myDirAU='D:\Tag data\FocalAccAnalysis\bb22_115a\Sound'
    ...
    specrecdir=('D:\Tag data\FocalAccAnalysis\bb22_115a\Spectrogram\');
